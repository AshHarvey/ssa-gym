...
def gcrs2irts_matrix_a(t, eop):
    ...
    Purpose:
        This function calculates the cartesian transformation matrix for transforming GCRS to ITRS or vice versa
    :param eop: is a dataframe containing the Earth Orientation Parameters as per IAU definitions
    :param t:   is a datetime object or a list of datetime objects with the UTC times for the transformation matrix to be
            calculated for
    :return:
